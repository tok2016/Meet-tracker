...
import MeetingFormPage from './MeetingFromPage';
...
const Router = () => {
  ...
  return (
    <Routes>
        ...
        <Route 
          ...
          element={isAvailable 
            ...
            : <Navigate to='/login' />}>
                ...
                <Route path='room' element={<MeetingFormPage />} />
      ...
      <Route path='/room/:id' element={room.id ? <MeetingPage /> : <Navigate to='/account/room' />} />
    </Routes>
  );
};
