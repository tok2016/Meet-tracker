...
const FilterFieldMobile = ({name, value, hidden=false, type='text', hideSort=false, selected=false, direction=1, onChange, onChoice}: FilterFieldMobileProps) => (
  <Stack
    ...
    gap='7px'
    alignItems='center'>
      <Typography display={type === 'date' ? 'inline' : 'none'} variant='body1'>
        {name}:
      </Typography>
